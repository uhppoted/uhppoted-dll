...
bool getDevice(uhppoted &u) {
    ...
    vector<result> rs = {
        ...
        result("IP address", string("192.168.1.100"), d.address),
...
bool getStatus(uhppoted &u) {
    ...
    vector<result> rs = {
        ...
        result("system date/time", string("2023-10-06 09:02:48"), s.sysdatetime),
        result("doors[1]", true, s.doors[0]),
        result("doors[2]", false, s.doors[1]),
        result("doors[3]", false, s.doors[2]),
        result("doors[4]", true, s.doors[3]),
        result("buttons[1]", false, s.buttons[0]),
        result("buttons[2]", true, s.buttons[1]),
        ...
        result("event timestamp", string("2023-10-05 12:23:38"), s.evt.timestamp),
        result("event index", uint32_t(483), s.evt.index),
        ...
        result("event card", uint32_t(10058400), s.evt.card),
