...
bool getTimeProfile() {
  ...
  return evaluate("get-time-profile", sizeof(resultset) / sizeof(result),
                  resultset);
}
...
bool setTimeProfile() {
  ...
  return evaluate("set-time-profile", sizeof(resultset) / sizeof(result),
                  resultset);
}
...
bool clearTimeProfiles() {
  ...
  return evaluate("clear-time-profiles", sizeof(resultset) / sizeof(result),
                  resultset);
}
