...
public class Tests {
    ...
    static bool GetDevice(Uhppoted u) {
        ...
        result[] resultset = {
            ...
            new stringResult("IP address", "192.168.1.100", device.address),
    ...
    static bool GetStatus(Uhppoted u) {
        ...
        result[] resultset = {
            ...
            new stringResult("system date/time", "2023-10-06 09:02:48", status.sysdatetime),
            ...
            new boolResult("buttons[1]", false, status.buttons[0]),
            new boolResult("buttons[2]", true, status.buttons[1]),
            ...
            new uint32Result("event index", 483, status.evt.index),
            new stringResult("event timestamp", "2023-10-05 12:23:38", status.evt.timestamp),
            ...
            new uint32Result("event card", 10058400, status.evt.card),
