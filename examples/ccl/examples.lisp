...
(defun get-device () "" 
  (let* ((device-id 405419896)
    ...
    (display "get-device" device-id device)))
...
(defun set-address () "" 
  (let ((device-id 405419896)
    ...
    (display "set-address" device-id nil)))


(defun get-status () "" 
  (let* ((device-id 405419896)
         (status (exec #'(lambda (u) (uhppoted-get-status u device-id)))))
    (display "get-status" device-id status)))


(defun get-time () "" 
  (let ((device-id 405419896))
    (exec #'(lambda (u) (uhppoted-get-time u device-id)))
    (display "get-time" device-id nil)))
...
(defun set-time () "" 
  (let ((device-id 405419896)
    ...
    (display "set-time" device-id nil)))


(defun get-listener () "" 
  (let ((device-id 405419896))
    (exec #'(lambda (u) (uhppoted-get-listener u device-id)))
    (display "get-listener" device-id nil)))
...
(defun set-listener () "" 
  (let ((device-id 405419896)
    ...
    (display "set-listener" device-id nil)))
...
(defun get-door-control () "" 
  (let* ((device-id 405419896)
    ...
    (display "get-door-control" device-id control)))
...
(defun set-door-control () "" 
  (let ((device-id 405419896)
    ...
    (display "set-door-control" device-id nil)))
...
(defun get-cards () "" 
  (let ((device-id 405419896))
    ...
    (display "get-cards" device-id nil)))
...
(defun get-card () "" 
  (let* ((device-id   405419896)
    ...
    (display "get-card" device-id card)))
...
(defun get-card-by-index () "" 
  (let* ((device-id 405419896)
    ...
    (display "get-card-by-index" device-id card)))
...
(defun put-card () "" 
  (let ((device-id   405419896)
    ...
    (display "put-card" device-id nil)))
...
(defun delete-card () "" 
  (let ((device-id   405419896)
    ...
    (display "delete-card" device-id nil)))
...
(defun get-event-index () "" 
  (let ((device-id 405419896))
    ...
    (display "get-event-index" device-id nil)))
...
(defun set-event-index () "" 
  (let ((device-id 405419896)
    ...
    (display "set-event-index" device-id nil)))
...
(defun get-event () "" 
  (let* ((device-id 405419896)
    ...
    (display "get-event" device-id event)))
...
(defun get-time-profile () "" 
  (let* ((device-id  405419896)
    ...
    (display "get-time-profile" device-id profile)))
...
(defun set-time-profile () "" 
  (let ((device-id  405419896)
    ...
    (display "set-time-profile" device-id profile)))
...
(defun add-task () "" 
  (let ((device-id  405419896)
    ...
    (display "add-task" device-id task)))
...
(defun display (tag device-id result) "" 
  (display-fields tag (cons (list "device-id" device-id) (as-fields result))))
